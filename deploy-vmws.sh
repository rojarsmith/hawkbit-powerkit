...
[Service]
User=root
ExecStart=/usr/bin/java -cp "/opt/hawkbit/lib/*:/opt/hawkbit/hawkbit-ui.jar" org.springframework.boot.loader.launch.JarLauncher --hawkbit.server.mgmtUrl=http://localhost:8080
SuccessExitStatus=143
Restart=always
RestartSec=10
StandardOutput=journal
